...
export const gifts: Gift[] = [
  ...
  },
  {
    id: "aula-de-danca",
    title: {
      pt: "Aula de dança para a primeira valsa",
      es: "Clase de baile para el primer vals",
      en: "Dance class for the first waltz",
      de: "Tanzstunde für den ersten Tanz",
    },
    description: {
      pt: "Para que a nossa primeira dança seja inesquecível, ajude-nos com uma aula de dança para os dois.",
      es: "Para que nuestro primer baile sea inolvidable, ayúdanos con una clase de baile para los dos.",
      en: "So our first dance is unforgettable, help us with a couples' dance class.",
      de: "Damit unser erster Tanz unvergesslich wird, helft uns mit einer Tanzstunde für uns beide.",
    },
    eurAmount: 40,
    brlAmount: 220,
    currencies: ["eur", "brl"],
